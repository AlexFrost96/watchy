...
def determine_aggregation_interval(start_time, end_time):
    ...
    #     return '5T'  # 5 minutes
    if total_duration <= 38200:  # Up to 1 hour
         return '5T'  # 5 minutes
    # elif total_duration <= 38200:  # Up to 12 hours
    #     return '10T'
    elif total_duration <= 86400:  # Up to 24 hours
        return '10T'  # 20 minutes
    elif total_duration <= 172800:  # Up to 48 hours
        return '20T'  # 40 min
    elif total_duration <= 604800:  # Up to 7 days
        return '30T'  # 1 hour
    elif total_duration <= 1209600:  # Up to 14 days
        return '1H'  # 2 hours
